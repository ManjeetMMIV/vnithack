...
async function runTests() {
    ...
    try {
        ...
        // -----------------------------------------------------
        console.log("[1/5] Testing Property Creation & Blockchain Hashing...");
        ...
        console.log("\n[2/5] Testing Blockchain Audit Verification...");
        ...
        console.log("\n[3/5] Testing Tamper Detection (The Hack)...");
        ...
        // -----------------------------------------------------
        console.log("\n[4/5] Testing Agent Server Health & Neo4j Data Sync...");
        ...
        console.log("\n[5/5] Testing LangGraph Multi-Agent Investigation Stream (SSE)...");
        ...
        await new Promise((resolve, reject) => {
            const req = http.get(`${AGENT_URL}/agent/analyze/CLK-089`, (res) => {
                ...
                res.on('data', (chunk) => {
                    ...
                    if (str.includes("data:")) {
                        if (!dataReceived) {
                            console.log("   Received first investigation logs from AI Agent...");
                            dataReceived = true;
                        }
                    }
            ...
            req.on('error', (err) => {
                console.log("   Note: Is the Agent Server running on port 3001 and configured with OpenAI/Neo4j keys?");
